 ...
 *
 * Usage: `php app/console partner_marketing:file_system:exists amazon_s3 dir/filename.png`
 */
class FindCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('partner_marketing:file_system:exists')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $adapter = $this->getContainer()->get('partner_marketing_file_system.factory')->build($adapterName);
